...
const projectsData = [
    ...
    },
    {
        ...
        peDescription: "مکانیک من یک وبسایت حرفه‌ای در زمینه تعمیرات خودرو است این وبسایت امکان ارتباط با مکانیک‌های حرفه‌ای و دریافت خدمات و تخفیفات ویژه را به مشتریان می‌دهد.",
